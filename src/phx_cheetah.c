...
int Cheetah_str_to_CheetahParamValue(char *str, CheetahParamValue *pbParamValue)
{
    ...
    /* Test Pattern */
    CHEETAH_TEST_MULTI(TEST, NONE)
    CHEETAH_TEST_MULTI(TEST, BW_CHECKER)
    CHEETAH_TEST_MULTI(TEST, GRAY)
    CHEETAH_TEST_MULTI(TEST, TAP_SEG)
    CHEETAH_TEST_MULTI(TEST, HOR_RAMP)
    CHEETAH_TEST_MULTI(TEST, VER_RAMP)
    CHEETAH_TEST_MULTI(TEST, BOTH_RAMP_STATIC)
    CHEETAH_TEST_MULTI(TEST, BOTH_RAMP_DYN)
    CHEETAH_TEST_MULTI(TEST, VERT_BAR)
    CHEETAH_TEST_MULTI(TEST, CENTER_CROSS)
    /* Bit Shift */
